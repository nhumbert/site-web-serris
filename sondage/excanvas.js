...
if(this.fillStyle.type_pattern_=="Image")
{
var t=fillStyle.type_
var ws=max.x-min.x;
var hs=max.y-min.y;
if(t=="repeat")
{
var deltaleft=-min.x;
var deltatop=-min.y;
lineStr.push('<g_vml_:fill',' position="',0,',',0,'"',' type="','tile','"',' src="',this.fillStyle.src,'" />');
}
else
{
var w=(this.canvas.clientWidth)*Z;
var h=(this.canvas.clientHeight)*Z;
...
var top=deltatop/hs;
lineStr.push('<g_vml_:fill',' position="',left,',',top,'"',' size="',wi/ws,',',hi/hs,'"',' alignshape="false"',' type="','frame','"',' type="','frame','"',' src="',this.fillStyle.src,'" />');
}
}
else 
{
...
lineStr.push('<g_vml_:fill type="',fillStyle.type_,'"',' method="none" focus="100%"',' color="',color1,'"',' color2="',color2,'"',' colors="',colors.join(','),'"',' opacity="',opacity2,'"',' o:opacity2="',opacity1,'"',' angle="',angle,'"',' focusposition="',focus.x,',',focus.y,'" />');
}
